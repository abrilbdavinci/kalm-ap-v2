    ...
    <div class="drawer-side z-50">
        ...
        <div class="menu bg-base-200 min-h-full w-80 p-0 rounded-l-4xl flex flex-col justify-between">
            <div>
                <div class="flex flex-col border-b p-5 pt-10 border-(--kälm-lighter)">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <RouterLink to="/perfil"><img src="/src/assets/img/pfp.svg" alt="usuario" class="h-10 w-auto rounded-full object-cover"></img></RouterLink>
                    </div>
            ...
            <ul class="p-4 gap-3">
                ...
                <li class="flex flex-row text-lg text-(--kälm-text)">
                    <RouterLink class="w-full justify-between items-center hover:bg-transparent" to="/tests">
                        Tests
                ...
                <li class="flex flex-row text-lg text-(--kälm-text)">
                    <RouterLink class="w-full justify-between items-center hover:bg-transparent" to="/resultados">
                        Mis Resultados
            ...
            <ul class="p-4">
                ...
                <li class="flex flex-row text-lg text-(--kälm-text)">
                    <a class="w-full justify-between items-center hover:bg-transparent" @click="logout">
                        Cerrar sesión
